...
public class CoalGeneratorMenu extends AbstractContainerMenu {
    public CoalGeneratorBlockEntity blockEntity;
    private Level level;
    ...
    public CoalGeneratorMenu(int id, Inventory inv, BlockEntity blockEntity, SimpleContainerData simpleContainerData) {
        super(ECScreens.COAL_GENERATOR_MENU.get(), id);
    ...
    protected CoalGeneratorMenu(@Nullable MenuType<?> type, int p_38852_) {
        super(type, p_38852_);
    }
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, GeneratorsBlock.COAL_GENERATOR.get());
    }
